...
with_node \
  ...
  --target "/Users/runner/work/squares/squares/ios/Pods/Target Support Files/Pods-Squares/ExpoModulesProvider.swift" \
  --entitlement "/Users/runner/work/squares/squares/ios/Squares/Squares.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-clipboard" "expo-constants" "expo-crypto" "expo-dev-launcher" "expo-dev-menu" "expo-device" "expo-file-system" "expo-font" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-notifications" "expo-web-browser"
